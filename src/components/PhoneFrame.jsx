...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-[366/729]', className)} {...props}>
      ...
      <div className="absolute top-[calc(21/729*100%)] rounded-xl left-[calc(22/366*100%)] grid h-[calc(687/729*100%)] w-[calc(322/366*100%)] transform grid-cols-1 overflow-hidden bg-white pt-[calc(0/318*100%)]">
        {children}
      </div>
